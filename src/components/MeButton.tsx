...
const ButtonRoot = React.forwardRef((props: React.PropsWithChildren<{}>, ref: React.ForwardedRef<any>) => {
...
const SvgButton = React.forwardRef((props: ButtonUnstyledProps, ref: React.ForwardedRef<any>) => (
